...
<body>
	<div id="container">
		...
		<div id="content">
			<div id="user">
				<form:form modelAttribute="userVo" method="post" action="${pageContext.request.contextPath }/user/join">					
					...
					<spring:message code="user.join.label.email.check" var="userEmailCheckText" />
					<input id="btn-check" type="button" value="${userEmailCheckText }">
